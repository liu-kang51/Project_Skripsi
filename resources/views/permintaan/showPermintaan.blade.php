                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="mb-4 ml-6">
                            ...
                            <span class="text-slate-900">{{ $permintaans->nama_pengajuan }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Nama Barang:</label>
                            <span class="text-slate-900">{{ $permintaans->nama_barang }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Nama Vendor:</label>
                            <span class="text-slate-900">{{ $permintaans->nama_vendor }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Jumlah:</label>
                            <span class="text-slate-900">{{ $permintaans->jumlah }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Jenis:</label>
                            <span class="text-slate-900">{{ $permintaans->jenis }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Total Harga:</label>
                            <span class="text-slate-900">Rp {{ number_format($permintaans->total_harga, 0, ',', '.') }}</span>
                        </div>
                        <div class="mb-4 ml-6">
                            <label class="font-medium text-slate-700">Deskripsi:</label>
                            <span class="text-slate-900">{{ $permintaans->deskripsi }}</span>
                        </div>
                    </div>
                </div>
                <div class="mt-10 ml-5">
                    <a href="{{ route('reportPermintaan.index') }}" class="btn btn-primary">Kembali</a>
